        ...
        <div className="  bg-white ">
          ...
          <div className="sm:flex sm:justify-between ">
            <div className="sm:flex gap-10 sm:gap-4 lg:gap-5 flex ">
              ...
              <div className="">
                <div className="sm:flex sm:flex-col gap-2 md:gap-0">
                  ...
                  <p className="text-xs font-semibold ">Paperback</p>
                  <p className="font-bold text-lg md:text-md">€22.03</p>
                  <div className="">
                  ...
                  <div className="flex items-center ">
                    ...
                    <p className="text-[#1BA1FF] font-bold  text-xs "> prime</p>
                  </div>
            ...
            <div className="sm:pr-2">
              <p className="sm:text-lg font-semibold hidden sm:block">€22.03</p>
            </div>
          </div>
